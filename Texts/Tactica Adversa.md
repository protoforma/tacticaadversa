...
Несколько примеров расположения СТ (в программе [Skilful Pro](https://protoforma.pro/skilfulpro/) данная точка обозначается как CP (Cause Point)). 

На графике Si.FORTS.Z2019 отмечена оранжевой стрелкой:
