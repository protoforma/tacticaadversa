...
- противоположная первой по направлению модель. Также от начала тренда. В случае, если одна из моделей коррекционная (МП или МДР), может потребоваться дополнительно исследовать 

- третью модель от начала тренда - совпадающую по направлению с первой и противоположную второй.

	

	Если ω принадлежит (располагается внутри, между ЛТ и ЛЦ) ближайшей модели от начала тренда λ~0~, то 
