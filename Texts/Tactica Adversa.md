...
Импульс (тонкий план) - своего рода **центр деятельности**, который приводит объект в воплощение и дальше озаряет и насыщает собой его жизнь, придавая сил и поддерживая цель существования. 
...
В качестве примера, СТ (в программе [Skilful Pro](https://protoforma.pro/skilfulpro/) данная точка обозначается как CP (Cause Point)) на графике Si.FORTS.Z2019 отмечена оранжевой стрелкой:

![Si.FORTS.Z2019](Tactica%20Adversa/Si.FORTS.Z2019.png)

Si.FORTS.Z2019

Или СТ модели с началом на 9 897 288 значении после запятой числа Пи:
