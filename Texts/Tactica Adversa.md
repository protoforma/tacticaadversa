...
**практически**, памятуя о том, что реальный объект на физическом плане остается недоступным[^2], а его взаимодействие со средой (свойства) может быть зафиксировано, представлено и истолковано Наблюдателем бесконечным количеством видов и форм (проекций), получить исчерпывающее/абсолютное/полное представление о динамическом процессе не представляется возможным.
