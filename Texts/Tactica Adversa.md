...
Тактика Адверза (ТА) - набор обобщений доведенных до уровня абстракций.[^1] Нет ничего проще и лучше, чем передать  абстрактное посредством элементарного образа (геометрического примитива), не ограниченного замкнутой ломаной или кривой, которые снижают уровень абстракции. 
